// Generated by tomltestgen for toml-test ref master on 2023-10-25T23:48:00+02:00
package toml_test
...
func TestTOMLTest_Invalid_Array_DoubleComma1(t *testing.T) {
	input := "double-comma-1 = [1,,2]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_DoubleComma2(t *testing.T) {
	input := "double-comma-2 = [1,2,,]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_ExtendDefinedAot(t *testing.T) {
	input := "[[tab.arr]]\n[tab]\narr.val1=1\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_ExtendingTable(t *testing.T) {
	input := "a = [{ b = 1 }]\n\n# Cannot extend tables within static arrays\n# https://github.com/toml-lang/toml/issues/908\n[a.c]\nfoo = 1\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_MissingSeparator1(t *testing.T) {
	input := "arrr = [true false]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_MissingSeparator2(t *testing.T) {
	input := "wrong = [ 1 2 3 ]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose1(t *testing.T) {
...
func TestTOMLTest_Invalid_Array_NoClose3(t *testing.T) {
	input := "no-close-3 = [42 #]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose4(t *testing.T) {
	input := "no-close-4 = [{ key = 42\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose5(t *testing.T) {
	input := "no-close-5 = [{ key = 42}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose6(t *testing.T) {
	input := "no-close-6 = [{ key = 42 #}]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose7(t *testing.T) {
	input := "no-close-7 = [{ key = 42} #]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoClose8(t *testing.T) {
	input := "no-close-8 = [\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoCloseTable1(t *testing.T) {
	input := "x = [{ key = 42\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Array_NoComma1(t *testing.T) {
	input := "no-comma-1 = [true false]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoComma2(t *testing.T) {
	input := "no-comma-2 = [ 1 2 3 ]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_NoComma3(t *testing.T) {
	input := "no-comma-3 = [ 1 #,]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_OnlyComma1(t *testing.T) {
	input := "only-comma-1 = [,]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Array_OnlyComma2(t *testing.T) {
	input := "only-comma-2 = [,,]\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Bool_CapitalizedFalse(t *testing.T) {
	input := "capitalized-false        = False\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Bool_CapitalizedTrue(t *testing.T) {
...
func TestTOMLTest_Invalid_Bool_MixedCaseFalse(t *testing.T) {
	input := "mixed-case-false        = falsE\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Bool_MixedCaseTrue(t *testing.T) {
...
func TestTOMLTest_Invalid_Control_CommentFf(t *testing.T) {
...
func TestTOMLTest_Invalid_Control_MultiCr(t *testing.T) {
...
func TestTOMLTest_Invalid_Control_RawmultiCd(t *testing.T) {
...
func TestTOMLTest_Invalid_Control_RawstringCr(t *testing.T) {
...
func TestTOMLTest_Invalid_Control_StringCr(t *testing.T) {
...
func TestTOMLTest_Invalid_Datetime_Feb29(t *testing.T) {
	input := "\"not a leap year\" = 2100-02-29T15:15:15Z\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Datetime_Feb30(t *testing.T) {
...
func TestTOMLTest_Invalid_Datetime_NoLeadsMonth(t *testing.T) {
...
func TestTOMLTest_Invalid_Encoding_BadCodepoint(t *testing.T) {
...
func TestTOMLTest_Invalid_Encoding_BadUtf8InMultilineLiteral(t *testing.T) {
	input := "# The following line contains an invalid UTF-8 sequence.\nbad = '''\xc3'''\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Encoding_BadUtf8InMultiline(t *testing.T) {
	input := "# The following line contains an invalid UTF-8 sequence.\nbad = \"\"\"\xc3\"\"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Encoding_BadUtf8InStringLiteral(t *testing.T) {
	input := "# The following line contains an invalid UTF-8 sequence.\nbad = '\xc3'\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Float_InfCapital(t *testing.T) {
	input := "v = Inf\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Float_NanCapital(t *testing.T) {
	input := "v = NaN\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Float_TrailingUsExp1(t *testing.T) {
	input := "trailing-us-exp-1 = 1_e2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Float_TrailingUsExp2(t *testing.T) {
...
func TestTOMLTest_Invalid_InlineTable_BadKeySyntax(t *testing.T) {
	input := "tbl = { a = 1, [b] }\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_InlineTable_DuplicateKey1(t *testing.T) {
	input := "# Duplicate keys within an inline table are invalid\na={b=1, b=2}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_DuplicateKey2(t *testing.T) {
	input := "table1 = { table2.dupe = 1, table2.dupe = 2 }\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_DuplicateKey3(t *testing.T) {
	input := "tbl = { fruit = { apple.color = \"red\" }, fruit.apple.texture = { smooth = true } }\n\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_DuplicateKey4(t *testing.T) {
	input := "tbl = { a.b = \"a_b\", a.b.c = \"a_b_c\" }\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Empty1(t *testing.T) {
	input := "t = {,}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Empty2(t *testing.T) {
	input := "t = {,\n}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Empty3(t *testing.T) {
	input := "t = {\n,\n}\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_InlineTable_NoClose1(t *testing.T) {
	input := "a={\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_NoClose2(t *testing.T) {
	input := "a={b=1\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_NoComma1(t *testing.T) {
	input := "t = {x = 3 y = 4}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_NoComma2(t *testing.T) {
	input := "arrr = { comma-missing = true valid-toml = false }\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite1(t *testing.T) {
	input := "a.b=0\n# Since table \"a\" is already defined, it can't be replaced by an inline table.\na={}\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite2(t *testing.T) {
	input := "a={}\n# Inline tables are immutable and can't be extended\n[a.b]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite3(t *testing.T) {
	input := "a = { b = 1 }\na.b = 2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite4(t *testing.T) {
	input := "inline-t = { nest = {} }\n\n[[inline-t.nest]]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite5(t *testing.T) {
	input := "inline-t = { nest = {} }\n\n[inline-t.nest]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite6(t *testing.T) {
	input := "a = { b = 1, b.c = 2 }\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite7(t *testing.T) {
	input := "tab = { inner.table = [{}], inner.table.val = \"bad\" }"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite8(t *testing.T) {
	input := "tab = { inner = { dog = \"best\" }, inner.cat = \"worst\" }"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_InlineTable_Overwrite9(t *testing.T) {
...
func TestTOMLTest_Invalid_Integer_InvalidHex1(t *testing.T) {
	input := "invalid-hex-1 = 0xaafz\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Integer_InvalidHex2(t *testing.T) {
...
func TestTOMLTest_Invalid_Key_DottedRedefineTable1(t *testing.T) {
	input := "a = false\na.b = true\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_DottedRedefineTable2(t *testing.T) {
...
func TestTOMLTest_Invalid_Key_EndInEscape(t *testing.T) {
...
func TestTOMLTest_Invalid_Key_QuotedUnclosed1(t *testing.T) {
	input := "\"key = x\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_QuotedUnclosed2(t *testing.T) {
	input := "\"key\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Key_StartDot(t *testing.T) {
	input := ".key = 1\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Key_WithoutValue3(t *testing.T) {
	input := "\"key\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_WithoutValue4(t *testing.T) {
	input := "\"key\" = \n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_WithoutValue5(t *testing.T) {
	input := "fs.fw\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_WithoutValue6(t *testing.T) {
	input := "fs.fw =\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Key_WithoutValue7(t *testing.T) {
	input := "fs.\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_Feb29(t *testing.T) {
	input := "\"not a leap year\" = 2100-02-29\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_Feb30(t *testing.T) {
	input := "\"only 28 or 29 days in february\" = 1988-02-30\n\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_MdayOver(t *testing.T) {
	input := "# date-mday       = 2DIGIT  ; 01-28, 01-29, 01-30, 01-31 based on\n#                           ; month/year\nd = 2006-01-32\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_MdayUnder(t *testing.T) {
	input := "# date-mday       = 2DIGIT  ; 01-28, 01-29, 01-30, 01-31 based on\n#                           ; month/year\nd = 2006-01-00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_MonthOver(t *testing.T) {
	input := "# date-month      = 2DIGIT  ; 01-12\nd = 2006-13-01\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_MonthUnder(t *testing.T) {
	input := "# date-month      = 2DIGIT  ; 01-12\nd = 2007-00-01\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_NoLeadsWithMilli(t *testing.T) {
	input := "# Day \"5\" instead of \"05\"; the leading zero is required.\nwith-milli = 1987-07-5\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_NoLeads(t *testing.T) {
	input := "# Month \"7\" instead of \"07\"; the leading zero is required.\nno-leads = 1987-7-05\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDate_TrailingT(t *testing.T) {
	input := "# Date cannot end with trailing T\nd = 2006-01-30T\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_Feb29(t *testing.T) {
	input := "\"not a leap year\" = 2100-02-29T15:15:15\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_Feb30(t *testing.T) {
	input := "\"only 28 or 29 days in february\" = 1988-02-30T15:15:15\n\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_HourOver(t *testing.T) {
	input := "# time-hour       = 2DIGIT  ; 00-23\nd = 2006-01-01T24:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_MdayOver(t *testing.T) {
	input := "# date-mday       = 2DIGIT  ; 01-28, 01-29, 01-30, 01-31 based on\n#                           ; month/year\nd = 2006-01-32T00:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_MdayUnder(t *testing.T) {
	input := "# date-mday       = 2DIGIT  ; 01-28, 01-29, 01-30, 01-31 based on\n#                           ; month/year\nd = 2006-01-00T00:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_MinuteOver(t *testing.T) {
	input := "# time-minute     = 2DIGIT  ; 00-59\nd = 2006-01-01T00:60:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_MonthOver(t *testing.T) {
	input := "# date-month      = 2DIGIT  ; 01-12\nd = 2006-13-01T00:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_MonthUnder(t *testing.T) {
	input := "# date-month      = 2DIGIT  ; 01-12\nd = 2007-00-01T00:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_NoLeadsWithMilli(t *testing.T) {
	input := "# Day \"5\" instead of \"05\"; the leading zero is required.\nwith-milli = 1987-07-5T17:45:00.12\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_NoLeads(t *testing.T) {
	input := "# Month \"7\" instead of \"07\"; the leading zero is required.\nno-leads = 1987-7-05T17:45:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_NoSecs(t *testing.T) {
	input := "# No seconds in time.\nno-secs = 1987-07-05T17:45\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_NoT(t *testing.T) {
	input := "# No \"t\" or \"T\" between the date and time.\nno-t = 1987-07-0517:45:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_SecondOver(t *testing.T) {
	input := "# time-second     = 2DIGIT  ; 00-58, 00-59, 00-60 based on leap second\n#                           ; rules\nd = 2006-01-01T00:00:61\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalDatetime_TimeNoLeads(t *testing.T) {
	input := "# Leading 0 is always required.\nd = 2023-10-01T1:32:00Z\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_HourOver(t *testing.T) {
	input := "# time-hour       = 2DIGIT  ; 00-23\nd = 24:00:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_MinuteOver(t *testing.T) {
	input := "# time-minute     = 2DIGIT  ; 00-59\nd = 00:60:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_NoSecs(t *testing.T) {
	input := "# No seconds in time.\nno-secs = 17:45\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_SecondOver(t *testing.T) {
	input := "# time-second     = 2DIGIT  ; 00-58, 00-59, 00-60 based on leap second\n#                           ; rules\nd = 00:00:61\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_TimeNoLeads2(t *testing.T) {
	input := "# Leading 0 is always required.\nd = 01:32:0\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_LocalTime_TimeNoLeads(t *testing.T) {
	input := "# Leading 0 is always required.\nd = 1:32:00\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_InlineTable20(t *testing.T) {
	input := "[product]\ntype = { name = \"Nail\" }\ntype.edible = false  # INVALID\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_InlineTable30(t *testing.T) {
	input := "[product]\ntype.name = \"Nail\"\ntype = { edible = false }  # INVALID\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_KeyValuePair1(t *testing.T) {
	input := "key = # INVALID\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_Keys2(t *testing.T) {
	input := "= \"no key name\"  # INVALID\n\"\" = \"blank\"     # VALID but discouraged\n'' = 'blank'     # VALID but discouraged\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_String40(t *testing.T) {
	input := "str4 = \"\"\"Here are two quotation marks: \"\". Simple enough.\"\"\"\nstr5 = \"\"\"Here are three quotation marks: \"\"\".\"\"\"  # INVALID\nstr5 = \"\"\"Here are three quotation marks: \"\"\\\".\"\"\"\nstr6 = \"\"\"Here are fifteen quotation marks: \"\"\\\"\"\"\\\"\"\"\\\"\"\"\\\"\"\"\\\".\"\"\"\n\n# \"This,\" she said, \"is just a pointless statement.\"\nstr7 = \"\"\"\"This,\" she said, \"is just a pointless statement.\"\"\"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_String70(t *testing.T) {
	input := "quot15 = '''Here are fifteen quotation marks: \"\"\"\"\"\"\"\"\"\"\"\"\"\"\"'''\n\napos15 = '''Here are fifteen apostrophes: ''''''''''''''''''  # INVALID\napos15 = \"Here are fifteen apostrophes: '''''''''''''''\"\n\n# 'That,' she said, 'is still pointless.'\nstr = ''''That,' she said, 'is still pointless.''''\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_Table90(t *testing.T) {
	input := "[fruit]\napple.color = \"red\"\napple.taste.sweet = true\n\n[fruit.apple]  # INVALID\n# [fruit.apple.taste]  # INVALID\n\n[fruit.apple.texture]  # you can add sub-tables\nsmooth = true\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Spec_Table91(t *testing.T) {
	input := "[fruit]\napple.color = \"red\"\napple.taste.sweet = true\n\n# [fruit.apple]  # INVALID\n[fruit.apple.taste]  # INVALID\n\n[fruit.apple.texture]  # you can add sub-tables\nsmooth = true\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_String_BadEscape3(t *testing.T) {
	input := "backslash = \"\\\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadHexEsc1(t *testing.T) {
	input := "bad-hex-esc-1 = \"\\x0g\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadHexEsc2(t *testing.T) {
	input := "bad-hex-esc-2 = \"\\xG0\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadHexEsc3(t *testing.T) {
	input := "bad-hex-esc-3 = \"\\x\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadHexEsc4(t *testing.T) {
	input := "bad-hex-esc-4 = \"\\x 50\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadHexEsc5(t *testing.T) {
...
func TestTOMLTest_Invalid_String_BadUniEsc1(t *testing.T) {
	input := "bad-uni-esc-1 = \"val\\ue\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc2(t *testing.T) {
	input := "bad-uni-esc-2 = \"val\\Ux\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc3(t *testing.T) {
	input := "bad-uni-esc-3 = \"val\\U0000000\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc4(t *testing.T) {
	input := "bad-uni-esc-4 = \"val\\U0000\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc5(t *testing.T) {
	input := "bad-uni-esc-5 = \"val\\Ugggggggg\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc6(t *testing.T) {
	input := "bad-uni-esc-6 = \"This string contains a non scalar unicode codepoint \\uD801\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_BadUniEsc7(t *testing.T) {
...
func TestTOMLTest_Invalid_String_MultilineBadEscape4(t *testing.T) {
	input := "backslash = \"\"\"\\\"\"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineEscapeSpace1(t *testing.T) {
	input := "a = \"\"\"\n  foo \\ \\n\n  bar\"\"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineEscapeSpace2(t *testing.T) {
	input := "bee = \"\"\"\nhee \\\n\ngee \\   \"\"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineLitNoClose1(t *testing.T) {
	input := "invalid = '''\n    this will fail\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineLitNoClose2(t *testing.T) {
	input := "x='''\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineLitNoClose3(t *testing.T) {
	input := "not-closed= '''\ndiibaa\nblibae ete\neteta\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineLitNoClose4(t *testing.T) {
	input := "bee = '''\nhee\ngee ''\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineNoClose1(t *testing.T) {
	input := "invalid = \"\"\"\n    this will fail\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_String_MultilineNoClose3(t *testing.T) {
	input := "not-closed= \"\"\"\ndiibaa\nblibae ete\neteta\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineNoClose4(t *testing.T) {
	input := "bee = \"\"\"\nhee\ngee \"\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_MultilineNoClose5(t *testing.T) {
	input := "bee = \"\"\"\nhee\ngee\\\t \n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_String_NoClose1(t *testing.T) {
	input := "no-ending-quote = \"One time, at band camp\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_NoClose2(t *testing.T) {
	input := "\"a-string\".must-be = \"closed\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_NoClose3(t *testing.T) {
	input := "no-ending-quote = 'One time, at band camp\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_String_NoClose4(t *testing.T) {
	input := "'a-string'.must-be = 'closed\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Table_AppendToArrayWithDottedKeys(t *testing.T) {
	input := "[[a.b]]\n\n[a]\nb.y = 2\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Table_ArrayNoClose1(t *testing.T) {
	input := "[[albums]\nname = \"Born to Run\"\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_ArrayNoClose2(t *testing.T) {
	input := "[[closing-bracket.missing]\nblaa=2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_DuplicateKeyDottedArray(t *testing.T) {
	input := "[fruit]\napple.color = \"red\"\n\n[[fruit.apple]]\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Invalid_Table_NoClose1(t *testing.T) {
	input := "[where will it end\nname = value\n\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_NoClose2(t *testing.T) {
	input := "[closing-bracket.missingö\nblaa=2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_NoClose3(t *testing.T) {
	input := "[\"where will it end]\nname = value\n\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_NoClose4(t *testing.T) {
	input := "[\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_NoClose5(t *testing.T) {
	input := "[fwfw.wafw\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_OverwriteArrayInParent(t *testing.T) {
	input := "[[parent-table.arr]]\n[parent-table]\nnot-arr = 1\narr = 2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_OverwriteBoolWithArray(t *testing.T) {
	input := "a=true\n[[a]]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_OverwriteWithDeepTable(t *testing.T) {
	input := "a=1\n[a.b.c.d]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_Redefine1(t *testing.T) {
	input := "# Define b as int, and try to use it as a table: error\n[a]\nb = 1\n\n[a.b]\nc = 2\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_Redefine2(t *testing.T) {
	input := "[t1]\nt2.t3.v = 0\n[t1.t2]\n"
	testgenInvalid(t, input)
}

func TestTOMLTest_Invalid_Table_Redefine3(t *testing.T) {
	input := "[t1]\nt2.t3.v = 0\n[t1.t2.t3]\n"
	testgenInvalid(t, input)
}
...
func TestTOMLTest_Valid_Key_Unicode(t *testing.T) {
	input := "# TOML 1.1 supports Unicode for bare keys.\n\n€ = 'Euro'\n😂 = \"rofl\"\na\u200db = \"zwj\"\nÅÅ = \"U+00C5 U+0041 U+030A\"\n\n[中文]\n中文 = {中文 = \"Chinese language\"}\n\n[[tiếng-Việt]]\ntiəŋ˧˦.viət̚˧˨ʔ = \"north\"\n\n[[tiếng-Việt]]\ntiəŋ˦˧˥.viək̚˨˩ʔ = \"central\"\n"
